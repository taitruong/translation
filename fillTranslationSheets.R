...
fillTranslationSheets <- function(excelFile, currentLangFile, currentMainFile, latestLangFile, latestMainFile) {
	...
	currentTranslation <- LoadTranslationAndCreateSummarySheet(currentLangFile, currentMainFile, workbook, 'Summary Current Translation')
	
	print('Reading latest translation files')
	latestTranslation <- LoadTranslationAndCreateSummarySheet(latestLangFile, latestMainFile, workbook, 'Summary Latest Translation')
